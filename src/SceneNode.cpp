...
SceneNode::SceneNode(Object* ob){
	...
	std::string vertexShader = myShader.LoadShader("C:\\Users\\Ian\\Documents\\CS4300\\inclass8-meyers-i\\shaders\\vert.glsl");
	std::string fragmentShader = myShader.LoadShader("C:\\Users\\Ian\\Documents\\CS4300\\inclass8-meyers-i\\shaders\\frag.glsl");
