...
void SDLGraphicsProgram::loop(){
    ...
    // Create our terrain
    Terrain* myTerrain = new Terrain(512,512,"C:\\Users\\Ian\\Documents\\CS4300\\inclass8-meyers-i\\terrain2.ppm");
	//Terrain* myTerrain = new Terrain(512, 512, "terrain2.ppm");
	Terrain* myTerrain2 = new Terrain(512, 512, 154);
    myTerrain->LoadTexture("C:\\Users\\Ian\\Documents\\CS4300\\inclass8-meyers-i\\colormap.ppm");
	myTerrain2->LoadTexture("C:\\Users\\Ian\\Documents\\CS4300\\inclass8-meyers-i\\color2.ppm");
	//myTerrain->LoadTexture("colormap.ppm");
	//myTerrain2->LoadTexture("color2.ppm");

	// Uncomment this if you want to redraw the color map
	//myTerrain2->drawColorMap();
    // Create a node for our terrain 
    SceneNode* terrainNode;
    //terrainNode = new SceneNode(myTerrain);
	terrainNode = new SceneNode(myTerrain2);
